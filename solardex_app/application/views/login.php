...
<head>
    ...
    <meta name="description" content="Solardex - Solar Energy Login">
    ...
    <!-- Title-->
    <title>Solardex - Solar Energy Login</title>
    <!-- Fonts-->
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12 col-sm-9 col-md-7 col-lg-6 col-xl-5">
                    <div class="text-center px-4"><img class="login-intro-img" src="<?= base_url() ?>assets/img/icons/icon.png" alt=""></div>
                    <!-- Register Form-->
                    <div class="register-form mt-4 px-4">
                        ...
                        <form action="<?= base_url() ?>user/login" method="post">
                            ...
                            <button class="btn w-100" style="background-color: #00aa5e; color:white; border-radius:15px" type="submit" id="TombolLogin">Masuk</button>
                        </form>
                    </div>
                </div>
            </div>
