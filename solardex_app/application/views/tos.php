    ...
    <div class="container">
        ...
        <div class="header-content header-style-four position-relative d-flex align-items-center justify-content-between">
            ...
            <div class="page-heading">
                <h6 class="mb-0">Terms & Condition</h6>
            </div>
            <!-- User Profile-->
    ...
    <div class="container pb-3">
        <div class="card">
            <div class="card-body">
                ...
                <p>
                    The BKK SMKN 1 Purwoasri app stores and processes personal data that
                    ...
                    that the BKK SMKN 1 Purwoasri app won’t work properly or at all.
                </p>
                <div>
                    <p>
